...
使用方法:
    python collect_identification_data.py <output_dir> [--duration 30] [--domain-id 0]

示例:
    python collect_identification_data.py ./data/varied_scenes/var_0000 --duration 30
...
示例:
  ...
  # 使用不同的domain_id
  python collect_identification_data.py ./data/test --duration 20 --domain-id 1
  
  # 只处理已有的CSV文件
  python collect_identification_data.py ./data/var_0000 --process-only raw_data_xxx.csv
"""
    )
